...
export const metadata: Metadata = {
  title: "TAQA Madinat Zayed Buildings - Strategic Feasibility Presentation",
  description: "Strategic route analysis and feasibility briefing for the TAQA Madinat Zayed Buildings project.",
};
